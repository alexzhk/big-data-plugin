...
public class TestShimConfig extends BaseRuntimeTest {
  ...
  public TestShimConfig( HadoopShim hadoopShim, MessageGetterFactory messageGetterFactory ) {
  ...
  @Override public RuntimeTestResultSummary runTest( Object objectUnderTest ) {
    ...
    try {
      ...
      Configuration config = hadoopShim.createConfiguration( namedCluster.getName() );
